export const mysqlHelpVerboseText = `mysqld  Ver 8.4.6 for macos26.0 on arm64 (Homebrew)
...
--no-login-paths        Don't read login paths from the login path file.
  ...
  --innodb-buffer-pool-in-core-file 
                      ...
                      then core dumping logic will not be affected. This option
                      is disabled by default if the platforms supports
                      MADV_DONTDUMP, otherwise it is enabled by default.
  ...
  --innodb-change-buffering=name 
                      Buffer changes to reduce random access: OFF (default),
                      ON, inserting, deleting, changing, or purging.
  ...
  --innodb-dedicated-server 
                      ...
                      innodb_redo_log_capacity based on system memory.
  ...
  --innodb-page-cleaners[=#] 
                      Page cleaner threads can be from 1 to 64. Default is
  ...
  --innodb-purge-threads[=#] 
                      Purge threads can be from 1 to 32. Default is 1 if number
                      of available CPUs is 16 or less, 4 otherwise.
  ...
  --innodb-use-fdatasync 
                      ...
                      (Defaults to on; use --skip-innodb-use-fdatasync to disable.)
...
back-log                                                     151
basedir                                                      /opt/homebrew/Cellar/mysql@8.4/8.4.6_3/
big-tables                                                   FALSE
...
character-sets-dir                                           /opt/homebrew/Cellar/mysql@8.4/8.4.6_3/share/mysql/charsets/
...
gdb                                                          FALSE
general-log                                                  FALSE
general-log-file                                             /opt/homebrew/var/mysql/Renes-MacBook-Pro.log
...
large-pages                                                  FALSE
lc-messages                                                  en_US
lc-messages-dir                                              /opt/homebrew/Cellar/mysql@8.4/8.4.6_3/share/mysql/
lc-time-names                                                en_US
local-infile                                                 FALSE
...
ndb-tls-search-path                                          $HOME/ndb-tls
...
performance-schema-error-size                                5548
...
pid-file                                                     /opt/homebrew/var/mysql/Renes-MacBook-Pro.pid
plugin-dir                                                   /opt/homebrew/Cellar/mysql@8.4/8.4.6_3/lib/plugin/
port                                                         3306
port-open-timeout                                            0
...
relay-log                                                    Renes-MacBook-Pro-relay-bin
relay-log-index                                              Renes-MacBook-Pro-relay-bin.index
...
replica-load-tmpdir                                          /var/folders/ct/m9h_cw_944z549w5r3gnxtb40000gn/T/
...
slave-load-tmpdir                                            /var/folders/ct/m9h_cw_944z549w5r3gnxtb40000gn/T/
...
slow-query-log-file                                          /opt/homebrew/var/mysql/Renes-MacBook-Pro-slow.log
...
tmpdir                                                       /var/folders/ct/m9h_cw_944z549w5r3gnxtb40000gn/T/
